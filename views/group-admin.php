...
<section id="content">
<?php
echo '	<header><h1>Groupe '.$group->getName().'</h1><span class="date">('.$group->getDateString().')</span><div><a href="?requ=suppr&id='.$group->getId().'" onclick="suppr(this); return false" title="supprimer"><span>Supprimer</span></a></div></header>';
?>
  <figure class="add">
