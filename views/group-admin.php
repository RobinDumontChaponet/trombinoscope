...
<section id="content">
<?php
echo '<header><form action = ""><h1>Groupe <input type="text" value="'.$group->getName().'"></h1><span class="date">('.$group->getDateString().')</span><div><a href="?requ=suppr&id='.$group->getId().'" onclick="suppr(this); return false" title="supprimer"><span>Supprimer</span></a></div></form></header>';
?>
  <figure class="add">
