<!--meta title="Trombinoscope | <?php echo (empty($_GET['id'])?'Nouvel étudiant':'Étudiant : '.$student->getFirstName().' '.$student->getName());?>" css="style/group.css" css="style/student.css"-->
