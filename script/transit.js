...
function csvArrayToTable(array) {
	...
	for(var i=0, l=array[0].length; i<l; i++) {
		headers.push('<select name="'+i+'"><option value="" disabled selected style="display:none;">Type</option><option value="unused">(inutilisé)</option><option value="name">Nom</option><option value="firstName">Prénom</option></select>');
	}
